...
function [modelname,paths,opts,submodels,prev_ident_pars] = options_Fujita_2exp_constEGF_zeroICs_fix2pars()
...
opts.replaceICs = 1;       % replace states with known initial conditions (= 1) or use generic values (= 0) when calculating rank
...
syms reaction_5_k1 reaction_5_k2 reaction_6_k1 scaleFactor_pS6
prev_ident_pars = [reaction_5_k1 reaction_5_k2];
